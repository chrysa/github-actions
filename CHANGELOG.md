...
- [SKIP CI] [GA] bump SonarSource/sonarqube-scan-action from 8.1.0 to 8.2.0 in /.github/workflows in the community-actions group (#129)
...
<ul>
<li>SQSCANGHA-149 Add scannerBinariesAuthHeader input by <a
href="https://github.com/henryju"><code>@​henryju</code></a> in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/246">SonarSource/sonarqube-scan-action#246</a></li>
<li>SQSCANGHA-88 Deprecate the SONARCLOUD_URL env variable support by <a
href="https://github.com/henryju"><code>@​henryju</code></a> in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/249">SonarSource/sonarqube-scan-action#249</a></li>
<li>SQSCANGHA-84 Remove outdated wget/curl references by <a
href="https://github.com/henryju"><code>@​henryju</code></a> in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/248">SonarSource/sonarqube-scan-action#248</a></li>
<li>SQSCANGHA-135 Fix scanner binaries always re-downloaded due to
incompatible 4-part version by <a
href="https://github.com/henryju"><code>@​henryju</code></a> in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/250">SonarSource/sonarqube-scan-action#250</a></li>
<li>SQSCANGHA-127 Rename downloaded file to .zip before extraction on
Windows by <a
href="https://github.com/henryju"><code>@​henryju</code></a> in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/251">SonarSource/sonarqube-scan-action#251</a></li>
</ul>
<p><strong>Full Changelog</strong>: <a
href="https://github.com/SonarSource/sonarqube-scan-action/compare/v8...v8.2.0">https://github.com/SonarSource/sonarqube-scan-action/compare/v8...v8.2.0</a></p>
</blockquote>
</details>
<details>
...
<ul>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/713881670b6b3676cda39549040e2d88c70d582e"><code>7138816</code></a>
SQSCANGHA-127 Rename downloaded file to .zip before extraction on
Windows (<a
href="https://redirect.github.com/sonarsource/sonarqube-scan-action/issues/251">#251</a>)</li>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/358113921641f7f7c0e0d1291c4177001d2a8aaf"><code>3581139</code></a>
SQSCANGHA-135 Fix scanner binaries always re-downloaded due to
incompatible 4...</li>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/c9d327c0246c0bbfe955144aa8a5e033bf766f52"><code>c9d327c</code></a>
SQSCANGHA-84 Remove outdated wget/curl references</li>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/b243e5198fc64cec6d5f9b3170ad94f86851bfe9"><code>b243e51</code></a>
SQSCANGHA-88 Deprecate the SONARCLOUD_URL env variable support</li>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/375c3f5c03ecb62a95a3cfd14a5ef46c790195a0"><code>375c3f5</code></a>
SQSCANGHA-149 Add scannerBinariesAuthHeader input for authenticated
binary do...</li>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/9c783232fe55f148dd34c3372385883cec34a238"><code>9c78323</code></a>
SQSCANGHA-144 Add gate jobs to QA workflows for branch protection</li>
<li>See full diff in <a
href="https://github.com/sonarsource/sonarqube-scan-action/compare/v8.1.0...v8.2.0">compare
view</a></li>
</ul>
</details>
<br />
...
score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=SonarSource/sonarqube-scan-action&package-manager=github_actions&previous-version=8.1.0&new-version=8.2.0)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`3bfabac`](3bfabacc24c9f784a8a856d6ac3eaf4e42271eca))
- [SKIP CI] [GA] bump actions/setup-node from 4 to 6 in /.github/workflows in the actions-official group (#128)

Bumps the actions-official group in /.github/workflows with 1 update:
...
Signed-off-by: dependabot[bot] <support@github.com>
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`18a07a6`](18a07a6e2317bde35da1a8b2ba9f64b50ec8d5d0))
...
- Fix(secret-scan): move permissions to job level (top-level broke reusable startup) (#99)

## What
Move `permissions` from the workflow top level to the `gitleaks` job
level.

## Why
`#98` added top-level `permissions: pull-requests: read` to this
reusable workflow. Every repo that calls it via `uses:` then got
**startup_failure** (the run never starts). Caller repos (e.g.
guideline-checker) succeeded before #98 and broke immediately after.
Declaring the permissions at job level is the canonical pattern for
reusable workflows and avoids the caller-subset validation that was
failing at queue time. Gitleaks still gets `pull-requests: read` to list
PR commits (fixes the original 403).

🤖 Generated with [Claude Code](https://claude.com/claude-code) ([`2963d99`](2963d9976154b3d29d9f42fe6fd849ab954ec955))
- Fix(sonar-scan-python): skip sonar.tests for non-existent test dirs (#107)

## Problem

`sonar-scan-python` always passes `-Dsonar.tests=${{ inputs.tests }}`
(input defaults to `tests`). Any consumer repo without a `tests/`
directory fails the SonarCloud scan:
...
This currently blocks every PR in `chrysa/shared-standards` (no `tests/`
dir).

## Fix

Add a `Resolve existing test directories` step that keeps only the
configured test dirs that actually exist, then injects
`-Dsonar.tests=<existing>` into the scanner args — or omits the flag
entirely when none exist. Repos that *do* have tests are unaffected.

## Follow-up

After merge, cut a release (e.g. `v1.1.1`) and repoint consumers pinned
to `@v1.1.0` (e.g. `chrysa/shared-standards`
...
Diagnosis of the wider rollout batch showed a second Sonar failure:
repos that **do** have a `tests/` dir under `sonar.sources="."` failed
with `File tests/... can't be indexed twice`. The action now also
appends existing test dirs to `sonar.exclusions`, so the main source set
and test set are disjoint. Both failure modes (missing dir, and overlap)
are fixed in one place. ([`dbdbc56`](dbdbc568606214e1958e7d2fc4b1981a2e5d8600))
- Fix(lint-python): resolve tool-setup via fully-qualified path (#110)

## Problem
`lint-python.yml` (reusable lint gate) referenced the tool-setup
composite as `./tool-setup`. As a reusable workflow called from a
consumer repo, `./` resolves to the **caller's** checkout — which has no
`tool-setup/` action. The lint gate would fail at "Setup environment"
before ruff/mypy ran. Never surfaced because Actions are billing-blocked
(no runs since 2026-06-05).

## Fix
Reference `chrysa/github-actions/tool-setup@v1.0.12` (fully qualified)
so it always resolves to this repo's composite.

## Impact
Unblocks the release-gated lint pattern for all consumers
(django-pytest, django-traceid pilots + the ~30-repo batch).

🤖 Generated with [Claude Code](https://claude.com/claude-code)

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`a014959`](a014959b6ec3fe0c792298287a4c9069c9a3a185))
- Fix(pre-commit): repair makefile-check hook indentation (#112)

## Problem
The `makefile-check` hook (wired at rev `v0.1.1-94`) was inserted one
indentation level shallower than its sibling hooks under the
`chrysa/pre-commit-tools` repo. That made `.pre-commit-config.yaml`
invalid YAML — pre-commit cannot load the config, so every commit needs
`--no-verify` and the release-gated lint replay cannot run.

## Fix
Realign the `- id: makefile-check` line to match its sibling hooks'
indentation. The config now loads (validated with `yaml.safe_load`). No
hook behavior change.

Part of an org-wide repair (31 repos affected by the same wiring
defect).

🤖 Generated with [Claude Code](https://claude.com/claude-code)

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`a07ebd1`](a07ebd1f613db61eb233043713eb5645b74f14a1))
- Fix(ci): typecheck-paths input for ci-python reports job (#119)

Decouple the mypy report target from sonar `sources`. Django-flat repos
set `sonar-sources: .` but mypy must target the package — new
`typecheck-paths` input (default `src`). actionlint clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`710f51e`](710f51e8b55fae5d722237ffe9ac98ab27bbd3ff))
- Fix(ci): typecheck-paths input for ci-python reports job (#120)

Decouple mypy report target from sonar `sources` (django-flat repos use
`sonar-sources: .`). New `typecheck-paths` input, default `src`.
actionlint clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`e0d3bdc`](e0d3bdc0ee7f2532013ad1d0052163737b9b458c))

### Changes

- [SKIP CI] [GA] bump the community-actions group in /.github/workflows with 3 updates (#104) ([`b6bc7e2`](b6bc7e2359f489c468c65dea378b37dc3640c2f9))
- [SKIP CI] [GA] bump the actions-official group in /.github/workflows with 2 updates (#103) ([`be60f78`](be60f788818c1c398ef4d13d7d212a4dadb5e180))
- [SKIP CI] [pre-commit] bump https://github.com/igorshubovych/markdownlint-cli from d36813544180cf94269aa8f1fb3dc145aab76d79 to c7c1c7640e610068e8e4754e9f1bf109bd987dc7 (#102) ([`36ab2cd`](36ab2cd626e3705124a84d494c8e76ae10c85af6))
- [SKIP CI] [GA] bump the community-actions group in /.github/workflows with 3 updates (#117)

Bumps the community-actions group in /.github/workflows with 3 updates:
...
Updates `chrysa/github-actions` from 1.0.12 to 1.1.3
<details>
<summary>Changelog</summary>
<p><em>Sourced from <a
href="https://github.com/chrysa/github-actions/blob/v1.1.3/CHANGELOG.md">chrysa/github-actions's
changelog</a>.</em></p>
<blockquote>
<h2>[1.1.3] - 2026-06-03</h2>
<h3>Bug Fixes</h3>
<ul>
<li>Fix(secret-scan): grant pull-requests:read for gitleaks PR commit
listing (<a
href="https://redirect.github.com/chrysa/github-actions/issues/98">#98</a>)</li>
</ul>
<h2>Problem</h2>
<p><code>gitleaks-action@v2</code> fails on <strong>every PR across all
consuming repos</strong>
with:</p>
<pre><code>GET /repos/chrysa/&lt;repo&gt;/pulls/&lt;n&gt;/commits → 403
&quot;Resource not accessible by integration&quot;
</code></pre>
<p>The action lists PR commits to scan only the diff. The reusable
<code>secret-scan.yml</code> declared <code>permissions: contents:
read</code> only, so the
<code>GITHUB_TOKEN</code> lacked <code>pull-requests: read</code>.</p>
<h2>Fix</h2>
<p>Add <code>pull-requests: read</code> to the workflow permissions
block.</p>
<h2>Impact</h2>
<p>Re-greens the <strong>Detect secrets (Gitleaks)</strong> check on
~160 open PRs once
consuming repos pick up the workflow.</p>
<p>🤖 Generated with <a href="https://claude.com/claude-code">Claude
Code</a></p>
<p>Co-authored-by: chrysa <a
href="mailto:greau.anthony+chrysa@gmail.com">greau.anthony+chrysa@gmail.com</a>
Co-authored-by: Claude Opus 4.8 <a
href="mailto:noreply@anthropic.com">noreply@anthropic.com</a> (<a
href="https://github.com/chrysa/github-actions/blob/v1.1.3/7eb346e196692578c8edc516da471daac0bed5ee"><code>7eb346e</code></a>)</p>
<h2>[1.1.2] - 2026-06-03</h2>
<h3>Bug Fixes</h3>
<ul>
<li>Fix(sonar-scan-python): revert to sonarqube-scan-action@v5 (fixes
api.sonarcloud.io 404) (<a
href="https://redirect.github.com/chrysa/github-actions/issues/97">#97</a>)</li>
</ul>
<h2>Problem</h2>
<p>The <code>v1.1.0</code> rewrite of <code>sonar-scan-python</code>
replaced
<code>SonarSource/sonarqube-scan-action@v5</code> with a manual
<code>sonar-scanner-cli 7.1.0.4889</code> download. That scanner targets
the new <code>api.sonarcloud.io</code>
endpoint and fails with:</p>
<pre><code>INFO  Detected project binding: NONEXISTENT
ERROR Error 404 on https://api.sonarcloud.io/analysis/analyses
EXECUTION FAILURE
</code></pre>
<p>This breaks SonarCloud analysis on every chrysa repo (none have an
ALM
binding configured), blocking the entire <code>standards-realign</code>
rollout</p>
<!-- raw HTML omitted -->
</blockquote>
<p>... (truncated)</p>
...
<ul>
<li><a
href="https://github.com/chrysa/github-actions/commit/9271f2ea8a5639edc1a07dcd8489629bbe222b8d"><code>9271f2e</code></a>
chore: update CHANGELOG.md for v1.1.3 [skip ci]</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/7eb346e196692578c8edc516da471daac0bed5ee"><code>7eb346e</code></a>
fix(secret-scan): grant pull-requests:read for gitleaks PR commit
listing (<a
href="https://redirect.github.com/chrysa/github-actions/issues/98">#98</a>)</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/dd0bd6ee4279f8593703f991977ce2713d2ef454"><code>dd0bd6e</code></a>
fix(sonar-scan-python): revert to sonarqube-scan-action@v5 (fixes
api.sonarcl...</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/4e52dd4bceb875e3be4740ea124f796bcad113d8"><code>4e52dd4</code></a>
chore(standards): realign gitignore + pre-commit + sonar (<a
href="https://redirect.github.com/chrysa/github-actions/issues/96">#96</a>)</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/8b039e4849805ee7071c99fadbdf2450bbc9753f"><code>8b039e4</code></a>
fix(sonar): repair sonar-scan-python (dead scanner pin → Maven Central +
retr...</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/9ef6cb7c65258340e9a2f447de75bc4d777fbdce"><code>9ef6cb7</code></a>
ci(actions): fix checkout@v4 and upload-artifact@v4 across all workflows
(<a
href="https://redirect.github.com/chrysa/github-actions/issues/94">#94</a>)</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/62d88ce732158b66fe3fd2ca2e78cc0eeec81d6f"><code>62d88ce</code></a>
fix(ci): implement dependabot-auto-merge as reusable workflow_call (<a
href="https://redirect.github.com/chrysa/github-actions/issues/93">#93</a>)</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/ef0f18e037727452678203697d23fb7ba5d81f90"><code>ef0f18e</code></a>
chore(ui-ux): reference ui-ux skill in CLAUDE.md (<a
href="https://redirect.github.com/chrysa/github-actions/issues/92">#92</a>)</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/4e3190c4bfb9c5da28276d4a8d348eb917d5d6c2"><code>4e3190c</code></a>
[SKIP CI] [GA] bump chrysa/github-actions from 1 to 1.0.12 in
/.github/workfl...</li>
<li><a
href="https://github.com/chrysa/github-actions/commit/6ba6e8c5a582b748117ed281c2cf55c1e013e477"><code>6ba6e8c</code></a>
[SKIP CI] [pre-commit] bump <a
href="https://github.com/igorshubovych/markdownlint-cli">https://github.com/igorshubovych/markdownlint-cli</a>...</li>
<li>Additional commits viewable in <a
href="https://github.com/chrysa/github-actions/compare/v1.0.12...v1.1.3">compare
view</a></li>
</ul>
</details>
<br />
...
<h2>v3.0.0</h2>
<h2>What's changed</h2>
<p>gitleaks-action v3 migrates the runtime from Node 20 to Node 24.
<strong>No changes to inputs, outputs, or behavior.</strong> Update your
workflow from <code>gitleaks/gitleaks-action@v2</code> to
<code>gitleaks/gitleaks-action@v3</code>.</p>
<h3>Migration</h3>
...
<ul>
<li><strong>June 2, 2026:</strong> GitHub flips the runner default to
Node 24. Workflows using <code>gitleaks-action@v2</code> (Node 20) will
still run, but only if
<code>ACTIONS_ALLOW_USE_UNSECURE_NODE_VERSION=true</code> is set as an
environment variable.</li>
<li><strong>September 16, 2026:</strong> Node 20 is removed from
GitHub-hosted runners entirely. <code>gitleaks-action@v2</code> stops
working regardless of any opt-out flag.</li>
</ul>
<h3>Changes</h3>
<ul>
<li><code>action.yml</code>: runtime <code>node20</code> →
<code>node24</code></li>
<li><code>@actions/core</code>: 1.10.0 → 1.11.1</li>
<li><code>dist/</code> rebuilt</li>
<li>Example workflows updated to <code>actions/checkout@v6</code> and
<code>gitleaks-action@v3</code></li>
<li>README updated with v3 migration guide</li>
</ul>
<h3>Self-hosted runners</h3>
<p>If you use self-hosted runners, ensure your runner version is
<code>&gt;= v2.327.1</code> (required for Node 24 support).</p>
</blockquote>
</details>
<details>
<summary>Commits</summary>
<ul>
<li><a
href="https://github.com/gitleaks/gitleaks-action/commit/e0c47f4f8be36e29cdc102c57e68cb5cbf0e8d1e"><code>e0c47f4</code></a>
chore: migrate to Node 24 runtime (v3)</li>
<li><a
href="https://github.com/gitleaks/gitleaks-action/commit/bf2dc8e55639c1e091e9b45970152e4313705814"><code>bf2dc8e</code></a>
Merge pull request <a
href="https://redirect.github.com/gitleaks/gitleaks-action/issues/191">#191</a>
from Olexandr88/patch-1</li>
<li><a
href="https://github.com/gitleaks/gitleaks-action/commit/b71323b056f4cc8c7f4cc7decfcc26b5e80b8e15"><code>b71323b</code></a>
Update README.md</li>
<li><a
href="https://github.com/gitleaks/gitleaks-action/commit/9c66aa96d2700e2b6aa0f9f7021ae6e5cc7a4375"><code>9c66aa9</code></a>
Update README.md</li>
<li><a
href="https://github.com/gitleaks/gitleaks-action/commit/186c3fea8923e06a92dc3806067ad6afaf53e754"><code>186c3fe</code></a>
Create FUNDING.yml</li>
<li>See full diff in <a
href="https://github.com/gitleaks/gitleaks-action/compare/v2.3.9...v3.0.0">compare
view</a></li>
</ul>
</details>
<br />

Updates `SonarSource/sonarqube-scan-action` from 8 to 8.1.0
<details>
<summary>Release notes</summary>
<p><em>Sourced from <a
href="https://github.com/sonarsource/sonarqube-scan-action/releases">SonarSource/sonarqube-scan-action's
...
<h2>What's Changed</h2>
<ul>
<li>SQSCANGHA-146 Add proxy support for GPG keyserver access by <a
href="https://github.com/henryju"><code>@​henryju</code></a> in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/244">SonarSource/sonarqube-scan-action#244</a></li>
<li>SQSCANGHA-148 Update SonarScanner CLI to 8.1.0.6389 by <a
href="https://github.com/github-actions"><code>@​github-actions</code></a>[bot]
in <a
href="https://redirect.github.com/SonarSource/sonarqube-scan-action/pull/232">SonarSource/sonarqube-scan-action#232</a></li>
</ul>
<p><strong>Full Changelog</strong>: <a
href="https://github.com/SonarSource/sonarqube-scan-action/compare/v8...v8.1.0">https://github.com/SonarSource/sonarqube-scan-action/compare/v8...v8.1.0</a></p>
</blockquote>
</details>
<details>
<summary>Commits</summary>
<ul>
<li><a
href="https://github.com/SonarSource/sonarqube-scan-action/commit/5ffbad44543237d1b339a5ed57a774432e19f3e4"><code>5ffbad4</code></a>
SQSCANGHA-120 Bump actions/setup-node from 4 to 5 (<a
href="https://redirect.github.com/sonarsource/sonarqube-scan-action/issues/211">#211</a>)</li>
<li><a
...
<li>See full diff in <a
href="https://github.com/sonarsource/sonarqube-scan-action/compare/v8...v8.1.0">compare
view</a></li>
</ul>
</details>
<br />
...
Signed-off-by: dependabot[bot] <support@github.com>
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`8900ac7`](8900ac7a160053eda80e9a5557b67cb10a8fa001))
- [SKIP CI] [GA] bump actions/checkout from 6.0.2 to 6.0.3 in /.github/workflows in the actions-official group across 1 directory (#116)

Bumps the actions-official group with 1 update in the /.github/workflows
...
Signed-off-by: dependabot[bot] <support@github.com>
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`d17e400`](d17e4008c1bd0f832c14bba10a9060fb9bb71cc6))
- [SKIP CI] [pre-commit] bump https://github.com/igorshubovych/markdownlint-cli from c7c1c7640e610068e8e4754e9f1bf109bd987dc7 to 7a245930f5bc46f67cb592a558604025ed07105d (#115)

Bumps
[https://github.com/igorshubovych/markdownlint-cli](https://github.com/igorshubovych/markdownlint-cli)
from c7c1c7640e610068e8e4754e9f1bf109bd987dc7 to
7a245930f5bc46f67cb592a558604025ed07105d.
<details>
<summary>Commits</summary>
<ul>
<li><a
href="https://github.com/igorshubovych/markdownlint-cli/commit/7a245930f5bc46f67cb592a558604025ed07105d"><code>7a24593</code></a>
Bump markdownlint from 0.40.0 to 0.41.0</li>
<li>See full diff in <a
href="https://github.com/igorshubovych/markdownlint-cli/compare/c7c1c7640e610068e8e4754e9f1bf109bd987dc7...7a245930f5bc46f67cb592a558604025ed07105d">compare
view</a></li>
</ul>
</details>
<br />
...
Signed-off-by: dependabot[bot] <support@github.com>
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`fe9e617`](fe9e61779eec60c6feebee6fdce5652f55942cad))
- [SKIP CI] [pre-commit] bump https://github.com/gitleaks/gitleaks from v8.30.0 to 8.30.1 (#114)

Bumps
[https://github.com/gitleaks/gitleaks](https://github.com/gitleaks/gitleaks)
from v8.30.0 to 8.30.1.
<details>
<summary>Release notes</summary>
<p><em>Sourced from <a
href="https://github.com/gitleaks/gitleaks/releases">https://github.com/gitleaks/gitleaks's
releases</a>.</em></p>
<blockquote>
<h2>v8.30.1</h2>
<h2>Changelog</h2>
<ul>
<li>83d9cd684c87d95d656c1458ef04895a7f1cbd8e update goreleaser</li>
<li>8d1f98c7967eb1e79cb44ac6241a124e145d2165 Removed unnecessary
functions from report template (<a
href="https://redirect.github.com/gitleaks/gitleaks/issues/2040">#2040</a>)</li>
<li>ca20267a84aa1fa2c2a9c1a13cdb50cafb48eeb0 its the simple things (<a
href="https://redirect.github.com/gitleaks/gitleaks/issues/2020">#2020</a>)</li>
<li>b66ac75e4fa93d86d78fccd6e2f36d2c0698b2a2 build: switch to Go 1.24
(<a
href="https://redirect.github.com/gitleaks/gitleaks/issues/2002">#2002</a>)</li>
</ul>
</blockquote>
</details>
<details>
...
<ul>
<li><a
href="https://github.com/gitleaks/gitleaks/commit/83d9cd684c87d95d656c1458ef04895a7f1cbd8e"><code>83d9cd6</code></a>
update goreleaser</li>
<li><a
href="https://github.com/gitleaks/gitleaks/commit/8d1f98c7967eb1e79cb44ac6241a124e145d2165"><code>8d1f98c</code></a>
Removed unnecessary functions from report template (<a
href="https://redirect.github.com/gitleaks/gitleaks/issues/2040">#2040</a>)</li>
<li><a
href="https://github.com/gitleaks/gitleaks/commit/ca20267a84aa1fa2c2a9c1a13cdb50cafb48eeb0"><code>ca20267</code></a>
its the simple things (<a
href="https://redirect.github.com/gitleaks/gitleaks/issues/2020">#2020</a>)</li>
<li><a
href="https://github.com/gitleaks/gitleaks/commit/b66ac75e4fa93d86d78fccd6e2f36d2c0698b2a2"><code>b66ac75</code></a>
build: switch to Go 1.24 (<a
href="https://redirect.github.com/gitleaks/gitleaks/issues/2002">#2002</a>)</li>
<li>See full diff in <a
href="https://github.com/gitleaks/gitleaks/compare/v8.30.0...v8.30.1">compare
view</a></li>
</ul>
</details>
<br />
...
[![Dependabot compatibility
score](https://dependabot-badges.githubapp.com/badges/compatibility_score?dependency-name=https://github.com/gitleaks/gitleaks&package-manager=pre_commit&previous-version=v8.30.0&new-version=8.30.1)](https://docs.github.com/en/github/managing-security-vulnerabilities/about-dependabot-security-updates#about-compatibility-scores)
...
Signed-off-by: dependabot[bot] <support@github.com>
Co-authored-by: dependabot[bot] <49699333+dependabot[bot]@users.noreply.github.com> ([`53022c7`](53022c7d5da8e43f2b699ad5896a6dce8b4711d0))

### Features

- Feat: add doc-drift composite action (#105)

## Why
Generalizes the doc/screenshot drift check piloted in
chrysa/sport-intelligence-hub#80. Lets any repo enforce, in its existing
CI job, that committed docs match the code — no copy-pasted shell.

## What
New composite action `doc-drift`:
- Runs `make <target>` (default `docs-code`) to regenerate code-derived
docs.
- Fails on `git diff --exit-code -- <paths>` (default `docs/`), emitting
a `::error::` with the fix command and a `--stat` of the drift.

Inputs: `target` (default `docs-code`), `paths` (default `docs/`).

## Usage
Slot into a job where the stack/toolchain is available (e.g. right after
the e2e step):
```yaml
...
## Contract
The consuming repo owns its generators behind a `make docs-code` target
(skeleton landing in Forge-Stack-Workshop/base-makefile). This action
only enforces the diff.
...
Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`63e2998`](63e2998c0e0f3a678f64bee5c399af3263d0d7ff))
- Feat(workflows): reusable lint-python workflow for release-gated lint (#106)

## Why
Lint (ruff + mypy + pre-commit replay) currently runs on **every branch
push and PR** across ~46 repos -> high GitHub Actions billing.

## What
Adds `.github/workflows/lint-python.yml` -- a `workflow_call` reusable
workflow that replays the full pre-commit suite in one job (`pre-commit
run --all-files --hook-stage pre-push` -> ruff/ruff-format at all stages
+ mypy at pre-push stage). Uses local `./tool-setup` so mypy (language:
system) has its deps/stubs.

## Rollout
Consumer repos call this as a **gate job at the top of `release.yml`**
(`version: needs: lint`) and drop the `lint`/`pre-commit` jobs from
`ci.yml`. Lint runs **once per release** instead of per push. Tests +
sonar keep gating PRs. Documented as ADR D-0002.
...
Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`2dd64a0`](2dd64a0d7c3442745beb44f50a4cef02b1ca3efd))
- Feat(ci): reusable lean ci-python workflow (#118)

Adds `.github/workflows/ci-python.yml` (workflow_call) — the generalized
lean CI all chrysa Python repos call.

Jobs: **lint** (pre-commit replay gate) · **reports** (ruff.json +
mypy.txt artifacts for Sonar) · **test** (coverage matrix) · **sonar**
(sonar-scan-python ingests reports). Inputs: package, sources,
project-key/name, python-versions, cov-fail-under, run-sonar. `secrets:
SONAR_TOKEN` optional.

Composite actions pinned @v1.1.3. Auto-versioning unchanged (each repo's
release.yml / GitVersion). actionlint clean.

🤖 Generated with [Claude Code](https://claude.com/claude-code)

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`a932545`](a932545e292f1df6d4c5a2a9ac75f79819cabbbd))
- Feat(ci): reusable ci-python-app workflow (compose-backed) (#121)

Companion to ci-python.yml for service apps: test job runs `make
docker-test` (compose services) instead of plain pytest; coverage.xml
collected best-effort for Sonar. Same pre-commit gate + reports + sonar.
actionlint clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`2e566f8`](2e566f87a910e90b66d66eabdd5100f0fd5ab940))
- Feat(ci): reusable ci-fullstack workflow (Makefile-contract driven) (#122)

Reusable CI for fullstack monorepos. Delegates to the §1 Makefile
contract (gate = `make pre-commit`, tests = `make <test-target>`, build
implicit) so it is robust to per-repo stack differences. Sonar scans
whole repo best-effort. actionlint clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`65ee8f6`](65ee8f6f4ed542f3c06c0cca41c7b460ebcc6f12))
- Feat(deploy): reusable deploy workflow (ghcr build/push + catalog gitops) (#123)

Extracts dev-nexus's deploy.yml into a reusable workflow_call:
build+push backend (+optional frontend) to GHCR on release, then
optional gitops bump of image tags in chrysa/catalog (ArgoCD rolls out).
Parametrized; repos become thin callers. Unblocks fast-deploy for the
~14 in-dev apps that publish no image yet. actionlint clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`3bcf222`](3bcf222f3e1aee0745de43424d5ee2d37abe8c73))
- Feat(deploy): add backend/frontend build-args inputs (#124)

Adds `backend-build-args` and `frontend-build-args` to the reusable
deploy workflow so callers can pass docker build args — needed for Vite
frontends that bake `VITE_API_URL` at build time (e.g. cdn-explorer).
actionlint clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com> ([`c1300a1`](c1300a1286b94c60e4432e13a9ed17b105afe67e))
- Feat(deploy): add frontend-target input (#125)

Lets callers build the frontend from a different Dockerfile target than
the backend (e.g. doc-gen: backend `api`, frontend `production`). Falls
back to `target` when empty — existing callers unaffected. actionlint
clean.

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com> ([`a8c3d4f`](a8c3d4f2965b7b91ff78f2bebb9ba4ce36c00966))

### Miscellaneous

- Chore(standards): realign gitignore + sonar pin (#100)
...
Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com> ([`ad1852f`](ad1852f06cb5688fcbeda3b8abca73151d27d354))
- Ci: fix dead label-sync action (marocchino 404 -> crazy-max v6) (#101)

Replace `marocchino/create-labels@v1.3.0` (the action repo is a 404 /
deleted, so this workflow was dead at runtime) with
`crazy-max/ghaction-github-labeler@v6` (SHA-pinned), `skip-delete: true`
so it only creates/updates labels from `.github/labels.yml` and never
removes in-use labels. Org-wide backfill of the shared sync-labels
template.

Verified: `.github/labels.yml` present; block matched the template
exactly.

Generated with Claude Code ([`e333c8b`](e333c8bd5bb81934b01393040354547f1201f88e))
- Chore(config): normalize repo to chrysa standard (#109)

Normalization wave (OPS-190, driven by shared-standards#84).

- **NEW** .editorconfig, .gitattributes, CONTRIBUTING.md
- **Pre-commit §8 upgrade** (gitleaks, conventional-pre-commit,
no-commit-to-branch, chrysa/pre-commit-tools; non-applicable stack hooks
excluded)
...
Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`6563f2c`](6563f2cef0fbcf279c2bf57a9962f3a53027459f))
- Chore(makefile): declare makefile-tier (lib) (#108)

Adds the `# makefile-tier: lib` marker required by the chrysa Makefile
contract (shared-standards EXECUTION_STANDARD.md §1, PR #87) and
enforced by the `makefile-check` hook (pre-commit-tools PR #200). No
target changes — this repo already conforms to the `lib` tier.

Part of the Makefile uniformization campaign (Phase C, wave 1:
marker-only).

🤖 Generated with [Claude Code](https://claude.com/claude-code)

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 (1M context) <noreply@anthropic.com> ([`3bef3fe`](3bef3fe8f85702daedbe5d67454205a17351caca))
- Ci(pre-commit): wire makefile-check hook (v0.1.1-94) (#111)

Wire the `makefile-check` hook (pre-commit-tools v0.1.1-94) into
pre-commit, enforcing the archetype-tiered Makefile contract
(shared-standards EXECUTION_STANDARD.md §1). Bumps the pre-commit-tools
rev to v0.1.1-94 (additive only — no existing hook changed) and adds `-
id: makefile-check`.

Completes the Makefile uniformization campaign (Phase C): the contract
is now enforced on every commit touching a Makefile.

🤖 Generated with [Claude Code](https://claude.com/claude-code)

Co-authored-by: chrysa <greau.anthony+chrysa@gmail.com>
Co-authored-by: Claude Opus 4.8 <noreply@anthropic.com> ([`4cf727a`](4cf727a5034e2775a582faa2525256a781666aad))
- Chore(claude): dump shared agents + .mcp.json + settings (#113)

## What
Propagate canonical Claude Code config from
`shared-standards/templates`:
- `.claude/agents/general-*.md` — 10 shared subagents
- `.mcp.json` — `base` archetype (github, notion), `${ENV}` placeholders
only
- `.claude/settings.json` — where missing

## Why
Fleet-wide Claude config consistency. Single source of truth:
`shared-standards/templates/`.

## Safety
- No hardcoded secrets in `.mcp.json` (only `${GITHUB_TOKEN}` /
`${NOTION_API_KEY}`), verified by
`shared-standards/scripts/verify-config.sh`.
- CI may be red due to the account-wide GitHub Actions billing issue
(not caused by this PR).

🤖 Generated with [Claude Code](https://claude.com/claude-code) ([`2d41056`](2d41056d237a9df053bd32d0bc383763dbebfc00))
